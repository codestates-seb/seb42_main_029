  ...
  return (
    <Wrapper>
      <LeftWrapper>
        ...
        <p>
          다양한 종류의 반려동물 용품과 음식, 건강 보조제, 그리고 애견용품 등을
          제공합니다.
        </p>
        <p>
          저희의 제품은 높은 품질, 안정성보장과 다양한 브랜드의 제품을 보유하고
          있습니다.
        </p>
        <p>
          또한, 무료배송 서비스를 제공하여 고객의 편리성을 최우선으로
          생각합니다.
        </p>
        <p>
          목표는 고객과 반려동물이 함께 행복하고 건강한 생활을 도와드리는 것
          입니다.
        </p>
        <p>따라서, 우리는 항상 고객의 요구를 충족시키기 위해 노력하고,</p>
        <p> 최상의 상품과 서비스를 제공하기 위해 노력할 것입니다.</p>
        <p>
          만약 반려동물과 함께 건강하고 행복한 삶을 원하신다면, 모두댕냥을
          방문해주세요!
        </p>
      </LeftWrapper>
      <RightWrapper>
